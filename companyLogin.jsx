...
// function CompanySignupLogin() {
//   const [form, setForm] = useState({ companyName: '', companyEmail: '', companyPassword: '' });
//   const [message, setMessage] = useState('');
...
//   const validateForm = () => {
//     if (!form.companyName || !form.companyEmail || !form.companyPassword) {
//       setMessage('All fields are required.');
//       return false;
//     }
...
//   const handleLogin = () => {
//     const savedData = JSON.parse(localStorage.getItem('companyData'));
//     if (savedData && savedData.companyEmail === form.companyEmail && savedData.companyPassword === form.companyPassword) {
//       setMessage('Company login successful!');
//     } else {
//       setMessage('Invalid company login details.');
//     }
//   };

//   return (
//     <div>
//       <h2>Company Signup/Login</h2>
//       <input type="text" name="companyName" placeholder="Company Name" value={form.companyName} onChange={handleChange} />
//       <input type="email" name="companyEmail" placeholder="Company Email" value={form.companyEmail} onChange={handleChange} />
//       <input type="password" name="companyPassword" placeholder="Password" value={form.companyPassword} onChange={handleChange} />
//       <button onClick={handleSignup}>Signup</button>
//       <button onClick={handleLogin}>Login</button>
//       <p>{message}</p>
//     </div>
